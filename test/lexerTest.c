    ...
    return createTestSet(s("Type forms lexer tests"), a, ((LexerTest[]) {
         ...
         (LexerTest) { .name = s("Generic function signature with type funcs"),
             ...
             .expectedOutput = expect(((Token[]){
                 ...
                 (Token){ .tp = tokIntro,          .pl2 = 4, .startBt = 2, .lenBts = 7 },
