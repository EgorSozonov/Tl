...
LexerTestSet* wordTests(Arena* a) {
    return createTestSet(allocLit("Word lexer test", a), a, ((LexerTest[]) {
        (LexerTest) { 
        ...
        (LexerTest) {
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorWordUnderscoresOnlyAtStart, a), a, ((Token[]){}))
        },
        (LexerTest) {
        ...
        (LexerTest) {
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorWordChunkStart, a), a, ((Token[]){}))
        },
        (LexerTest) {
...
LexerTestSet* numericTests(Arena* a) {
    return createTestSet(allocLit("Numeric lexer test", a), a, ((LexerTest[]) {
        (LexerTest) { 
        ...
        (LexerTest) { 
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorNumericBinWidthExceeded, a), a, ((Token[]) {
                (Token){ .tp = tokStmt }
            }))
        },  
        (LexerTest) { 
        ...
        (LexerTest) {
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorNumericFloatWidthExceeded, a), a, ((Token[]) {
                (Token){ .tp = tokStmt }
            }))
        },
        (LexerTest) {
        ...
        (LexerTest) { 
            ...
            .input = allocLit("3_", a),
            .expectedOutput = buildLexerWithError(allocLit(errorNumericEndUnderscore, a), a, ((Token[]) {
                (Token){ .tp = tokStmt }
        }))},       
        (LexerTest) { .name = allocLit("Int numeric error 2", a),
            .input = allocLit("9_223_372_036_854_775_808", a),
            .expectedOutput = buildLexerWithError(allocLit(errorNumericIntWidthExceeded, a), a, ((Token[]) {
                (Token){ .tp = tokStmt }
        }))}                                             
    }));
}
...
LexerTestSet* stringTests(Arena* a) {
    return createTestSet(allocLit("String literals lexer tests", a), a, ((LexerTest[]) {
        ...
        (LexerTest) { .name = allocLit("String literal unclosed", a),
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorPrematureEndOfInput, a), a, ((Token[]) {
                (Token){ .tp = tokStmt }
        }))}
    }));
}
...
LexerTestSet* commentTests(Arena* a) {
    return createTestSet(allocLit("Comments lexer tests", a), a, ((LexerTest[]) {
...
LexerTestSet* punctuationTests(Arena* a) {
    return createTestSet(allocLit("Punctuation lexer tests", a), a, ((LexerTest[]) {
        ...
        (LexerTest) { .name = allocLit("Parens unclosed", a),
            .input = allocLit("(car (other car) cdr", a),
            .expectedOutput = buildLexerWithError(allocLit(errorPunctuationExtraOpening, a), a, ((Token[]) {
                (Token){ .tp = tokStmt },
        ...
        (LexerTest) { .name = allocLit("Brackets mismatched", a),
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorPunctuationUnmatched, a), a, ((Token[]) {
                (Token){ .tp = tokStmt },
        ...
        (LexerTest) { .name = allocLit("Dot usage error", a),
            .input = allocLit("foo (bar .baz)", a), 
            .expectedOutput = buildLexerWithError(allocLit(errorPunctuationOnlyInMultiline, a), a, ((Token[]) {
                (Token){ .tp = tokStmt },
                (Token){ .tp = tokWord, .startByte = 0, .lenBytes = 3 },
...
LexerTestSet* operatorTests(Arena* a) {
    return createTestSet(allocLit("Operator lexer tests", a), a, ((LexerTest[]) {
        ...
        (LexerTest) { .name = allocLit("Operator assignment in parens error", a),
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorOperatorAssignmentPunct, a), a, ((Token[]) {
                (Token){ .tp = tokStmt },
                (Token){ .tp = tokParens, .startByte = 1},
        ...
        (LexerTest) { .name = allocLit("Operator assignment multiple error 1", a),
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorOperatorMultipleAssignment, a), a, ((Token[]) {
        ...
        (LexerTest) { .name = allocLit("Definition of mutable var", a),
            .input = allocLit("mut x = 10", a),
            .expectedOutput = buildLexer(a, ((Token[]){
                (Token){ .tp = tokAssignment, .payload1 = 1, .payload2 = 2, .lenBytes = 10 },
                (Token){ .tp = tokWord, .startByte = 4, .lenBytes = 1 },
                (Token){ .tp = tokInt, .payload2 = 10, .startByte = 8, .lenBytes = 2 },
        }))},
        (LexerTest) { .name = allocLit("Definition of mutable var error", a),
            .input = allocLit("mut x := 10", a),
            .expectedOutput = buildLexerWithError(allocLit(errorOperatorMutableDef, a), a, ((Token[]){
                (Token){ .tp = tokMutTemp },
                (Token){ .tp = tokWord, .startByte = 4, .lenBytes = 1 }
        }))}  
    }));
...
LexerTestSet* coreFormTests(Arena* a) {
    return createTestSet(allocLit("Core form lexer tests", a), a, ((LexerTest[]) {
        ...
        (LexerTest) { .name = allocLit("Statement-type core form error", a),
            ...
            .expectedOutput = buildLexerWithError(allocLit(errorCoreNotInsideStmt, a), a, ((Token[]) {
                (Token){ .tp = tokStmt },
                (Token){ .tp = tokWord, .startByte = 0, .lenBytes = 1 },                // x
        ...
        (LexerTest) { .name = allocLit("Paren-type form error 1", a),
            .input = allocLit("if x <> 7 > 0", a),
            .expectedOutput = buildLexerWithError(allocLit(errorCoreMissingParen, a), a, ((Token[]) {})
        )},
        (LexerTest) { .name = allocLit("Paren-type form error 2", a),
            .input = allocLit("(brr if x <> 7 > 0)", a),
            .expectedOutput = buildLexerWithError(allocLit(errorCoreNotAtSpanStart, a), a, ((Token[]) {
                (Token){ .tp = tokStmt },
                (Token){ .tp = tokParens, .startByte = 1 },                
                (Token){ .tp = tokWord, .startByte = 1, .lenBytes = 3 }
        }))},
