...
inner class LexWordTest {
    ...
    @Test
    fun `Simple function call lexing`() {
        testInpOutp("foo 10 2 3") {
            it.build(tokStm, 4, 0, 10)
              .build(tokWord, 0, 0, 3)
              .buildLitInt(10, 4, 2)
              .buildLitInt(2, 7, 1)
              .buildLitInt(3, 9, 1)
    ...
    fun `Word snake case forbidden`() {
        testInpOutp("asdf_abc") {
            it.build(tokStm, 0, 0, 0).bError(errorWordUnderscoresOnlyAtStart)
        }
    }
    ...
    fun `Word incorrect capitalization`() {
        testInpOutp("Asdf.Abcd") {
            it.build(tokStm, 0, 0, 0).bError(errorWordCapitalizationOrder)
        }
    }
    ...
    fun `Word starts with 2 underscores error`() {
        testInpOutp("__abc") {
            it.build(tokStm, 0, 0, 0).bError(errorWordChunkStart)
        }
    }
    ...
    fun `@-Word`() {
        testInpOutp("@a123 ") {
            it.build(tokStm, 1, 0, 6).build(tokAtWord, 0, 0, 5)
        }
    }
    ...
    fun `At-reserved word`() {
        testInpOutp("@if") {
            it.build(tokStm, 1, 0, 3).build(tokAtWord, 0, 0, 3)
        }
    }
}
...
inner class LexNumericTest {
    ...
    fun `Binary numeric 64-bit zero`() {
        testInpOutp("0b0") {
            it.build(tokStm, 1, 0, 3).build(tokInt, 0, 0, 3)
        }
    }
    ...
    fun `Binary numeric basic`() {
        testInpOutp("0b101") {
            it.build(tokStm, 1, 0, 5).build(tokInt, 5, 0, 5)
        }
    }
    ...
    fun `Binary numeric 64-bit positive`() {
        testInpOutp("0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0111") {
            it.build(tokStm, 1, 0, 81).build(tokInt, 7, 0, 81)
        }
    }
    ...
    fun `Binary numeric 64-bit negative`() {
        testInpOutp("0b1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1001") {
            it.build(tokStm, 1, 0, 81).buildLitInt(-7, 0, 81)
        }
    }
    ...
    fun `Binary numeric 65-bit error`() {
        testInpOutp("0b0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_01110") {
            it.build(tokStm, 0, 0, 0).bError(errorNumericBinWidthExceeded)
        }
    }
    ...
    fun `Hex numeric 1`() {
        testInpOutp("0x15") {
            it.build(tokStm, 1, 0, 4).build(tokInt, 21, 0, 4)
        }
    }
    ...
    fun `Hex numeric 2`() {
        testInpOutp("0x05") {
            it.build(tokStm, 1, 0, 4).build(tokInt, 5, 0, 4)
        }
    }
    ...
    fun `Hex numeric 3`() {
        testInpOutp("0xFFFFFFFFFFFFFFFF") {
            it.build(tokStm, 1, 0, 18).buildLitInt(-1L, 0, 18)
        }
    }
    ...
    fun `Hex numeric 4`() {
        testInpOutp("0xFFFFFFFFFFFFFFFE") {
            it.build(tokStm, 1, 0, 18).buildLitInt(-2L, 0, 18)
        }
    }
    ...
    fun `Float numeric 1`() {
        testInpOutp("1.234") {
            it.build(tokStm, 1, 0, 5).buildLitFloat(1.234, 0, 5)
        }
    }
    ...
    fun `Float numeric 2`() {
        testInpOutp("00001.234") {
            it.build(tokStm, 1, 0, 9).buildLitFloat(1.234, 0, 9)
        }
    }
    ...
    fun `Float numeric 3`() {
        testInpOutp("10500.01") {
            it.build(tokStm, 1, 0, 8).buildLitFloat(10500.01, 0, 8)
        }
    }
    ...
    fun `Float numeric 4`() {
        testInpOutp("0.9") {
            it.build(tokStm, 1, 0, 3).buildLitFloat(0.9, 0, 3)
        }
    }
    ...
    fun `Float numeric 5`() {
        testInpOutp("100500.123456") {
            it.build(tokStm, 1, 0, 13).buildLitFloat(100500.123456, 0, 13)
        }
    }
    ...
    fun `Float numeric big`() {
        testInpOutp("9007199254740992.0") {
            it.build(tokStm, 1, 0, 18).buildLitFloat(9007199254740992.0, 0, 18)
        }
    }
    ...
    fun `Float numeric too big`() {
        testInpOutp("9007199254740993.0") {
            it.build(tokStm, 0, 0, 0).bError(errorNumericFloatWidthExceeded)
        }
    }
    ...
    fun `Float numeric big exponent`() {
        testInpOutp("1005001234560000000000.0") {
            it.build(tokStm, 1, 0, 24).buildLitFloat(1005001234560000000000.0, 0, 24)
        }
    }
    ...
    fun `Float numeric tiny`() {
        testInpOutp("0.0000000000000000000003") {
            it.build(tokStm, 1, 0, 24).buildLitFloat(0.0000000000000000000003, 0, 24)
        }
    }
    ...
    fun `Float numeric negative 1`() {
        testInpOutp("-9.0") {
            it.build(tokStm, 1, 0, 4).buildLitFloat(-9.0, 0, 4)
        }
    }
    ...
    fun `Float numeric negative 2`() {
        testInpOutp("-8.775_807") {
            it.build(tokStm, 1, 0, 10).buildLitFloat(-8.775_807, 0, 10)
        }
    }
    ...
    fun `Float numeric negative 3`() {
        testInpOutp("-1005001234560000000000.0") {
            it.build(tokStm, 1, 0, 25).buildLitFloat(-1005001234560000000000.0, 0, 25)
        }
    }
    ...
    fun `Int numeric 1`() {
        testInpOutp("3") {
            it.build(tokStm, 1, 0, 1).build(tokInt, 3, 0, 1)
        }
    }
    ...
    fun `Int numeric 2`() {
        testInpOutp("12") {
            it.build(tokStm, 1, 0, 2).build(tokInt, 12, 0, 2)
        }
    }
    ...
    fun `Int numeric 3`() {
        testInpOutp("0987_12") {
            it.build(tokStm, 1, 0, 7).build(tokInt, 98712, 0, 7)
        }
    }
    ...
    fun `Int numeric 4`() {
        testInpOutp("9_223_372_036_854_775_807") {
            it.build(tokStm, 1, 0, 25).buildLitInt(9_223_372_036_854_775_807L, 0, 25)
        }
    }
    ...
    fun `Int numeric negative 1`() {
        testInpOutp("-1") {
            it.build(tokStm, 1, 0, 2).buildLitInt(-1L, 0, 2)
        }
    }
    ...
    fun `Int numeric negative 2`() {
        testInpOutp("-775_807") {
            it.build(tokStm, 1, 0, 8).buildLitInt(-775_807L, 0, 8)
        }
    }
    ...
    fun `Int numeric negative 3`() {
        testInpOutp("-9_223_372_036_854_775_807") {
            it.build(tokStm, 1, 0, 26).buildLitInt(-9_223_372_036_854_775_807L, 0, 26)
        }
    }
    ...
    fun `Int numeric error 1`() {
        testInpOutp("3_") {
            it.build(tokStm, 0, 0, 0).bError(errorNumericEndUnderscore)
        }
    }
    ...
    fun `Int numeric error 2`() {
        testInpOutp("9_223_372_036_854_775_808") {
            it.build(tokStm, 0, 0, 0).bError(errorNumericIntWidthExceeded)
        }
    }
}
...
inner class LexStringTest {
    ...
    fun `String simple literal`() {
        testInpOutp("\"asdf\"") {
            it.build(tokStm, 1, 0, 6).build(tokString, 0, 1, 4)
        }
    }
    ...
    fun `String literal with escaped apostrophe inside`() {
        testInpOutp("\"wasn't so sure\"") {
            it.build(tokStm, 1, 0, 16).build(tokString, 0, 1, 14)
        }
    }
    ...
    fun `String literal unclosed`() {
        testInpOutp("\"asdf") {
            it.build(tokStm, 0, 0, 0).bError(errorPrematureEndOfInput)
        }
    }
}
...
inner class LexOperatorTest {
    ...
    fun `Operator simple 1`() {
        testInpOutp("+") {
            it.build(tokStm, 1, 0, 1).buildOperator(opTPlus, false, false, 0, 1)
        }
    }
    ...
    fun `Function simple 1`() {
        testInpOutp("foo = (\\x y. x - y)") {
            it.buildAll(tokStmtAssignment shl 26, 19, opTImmDefinition shl 2, 9)
              ...
              .buildPunctuation(tokStm, 2, 8, 3)
              .build(tokWord, 0, 8, 1)
              .build(tokWord, 0, 10, 1)
              .buildPunctuation(tokStm, 3, 13, 5)
