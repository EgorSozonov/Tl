    ...
    return createTestSet(s("Assignment test set"), a, ((ParserTest[]){
        ...
        createTestWithLocs(
            ...
            ((Node[]) {
                ...
                (Node){ .tp = nodExpr, .pl2 = 1 },
                (Node){ .tp = tokInt,  .pl2 = 12 },
                (Node){ .tp = nodAssignment, .pl1 = 1, .pl2 = 0}, // second
                (Node){ .tp = nodExpr, .pl2 = 1 },
                (Node){ .tp = nodId,          .pl2 = 0 }
            }),
            ((Int[]) {}),
        ...
        createTest(
            ...
            ((Node[]) {
                ...
                (Node){ .tp = nodAssignment, .pl1 = 1,  .pl2 = 0 },   // x
                (Node){ .tp = nodExpr, .pl2 = 1         },
                (Node){ .tp = tokString,                   },
