...
//import lexer.operatorDefinitions
...
//    ast.functionBodies.seek(entryPoint.bodyId)
//    val entryPointLenNodes = ast.functionBodies.currChunk.nodes[ast.functionBodies.currInd + 3]
//    backtrack.add(CodegenFrame(functionDef, 0, entryPoint.bodyId, entryPointLenNodes))
//
//    while (ast.functionBodies.currNodeInd != (entryPoint.bodyId + entryPointLenNodes + 1)) {
//        val spanType = ast.currNodeType()
//        val lenNodes = ast.functionBodies.currChunk.nodes[ast.functionBodies.currInd + 3]
//        val fr = backtrack.last()
//        if (spanType == functionDef.internalVal.toInt()) {
//            writeEntryPointSignature(fr, lenNodes, wr)
//        } else if (spanType == scope.internalVal.toInt()) {
//            writeScope(fr, lenNodes, wr)
//        } else if (spanType == expression.internalVal.toInt()) {
//            writeExpression(fr, lenNodes, wr)
//        } else if (spanType == returnExpression.internalVal.toInt()) {
//            writeReturn(fr, lenNodes, wr)
//        } else if (spanType == exturnExpression.internalVal.toInt()) {
//            writeExturn(fr, lenNodes, wr)
//        } else if (spanType == statementAssignment.internalVal.toInt()) {
//            writeAssignment(fr, lenNodes, wr)
//        } else if (spanType == fnDefPlaceholder.internalVal.toInt()) {
...
//    val eType = SpanAST.values().first {it.internalVal.toInt() == ast.currChunk.nodes[ast.currInd] ushr 27 }
...
//            } else {
//                // operator
//                val operString: String = operatorDefinitions[payload2].name
