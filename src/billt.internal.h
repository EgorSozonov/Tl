...
void decodeDerefArgA(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
void decodeDerefArgB(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
void decodeDerefArgC(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
void decodeDerefArgD(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
void decodeDerefArgE(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
void decodeDerefArgF(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
void decodeIntArgB(uint64_t instr, int64_t* callFrame, OConstant (*constants)[],  int64_t* result);
void decodeIntArgC(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result);
void decodePlainArgA(uint64_t instr, int64_t* result);
void decodePlainArgB(uint64_t instr, int64_t* result);
void decodePlainArgC(uint64_t instr, int64_t* result);
void decodePlainArgD(uint64_t instr, int64_t* result);

int decodeSignedArgBx(uint64_t instr);

//void decodeLiteralArgA(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
//void decodeSlotArgB(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
//void decodeSlotArgC(uint64_t instr, int64_t* callFrame, OConstant (*constants)[], int64_t* result, bool* isConstant);
